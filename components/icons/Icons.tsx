...
export const UserGroupIcon: React.FC<IconProps> = ({ className = 'h-6 w-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m-7.5-2.962c.566-.16-.566.16-1.132 0l-4.562.894a1.875 1.875 0 00-1.025 1.745v.5a1.875 1.875 0 001.875 1.875h15.75a1.875 1.875 0 001.875-1.875v-.5a1.875 1.875 0 00-1.025-1.745l-4.562-.894a1.875 1.875 0 01-1.132 0zM12 14.25a5.25 5.25 0 100-10.5 5.25 5.25 0 000 10.5zM12 14.25z" />
    </svg>
);
...
export const Cog6ToothIcon: React.FC<IconProps> = ({ className = 'h-5 w-5' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.594 3.94c.09-.542.56-1.007 1.11-.994h2.593c.55 0 1.02.453 1.11.994l.217 1.313c.22.132.433.28.632.448l1.17-.521c.5-.222 1.09.079 1.32.529l1.296 2.247c.23.399.026.916-.474 1.139l-1.09.486c-.052.12-.09.243-.118.368l.52 1.171c.224.5.023 1.09-.528 1.32l-2.247 1.296c-.399.23-.916.025-1.14-.475l-.486-1.09c-.12.052-.243.09-.368.118l-1.171.52c-.5.224-1.09.023-1.32-.528l-1.296-2.247c-.23-.399-.026-.916.475-1.14l1.09-.486c.052-.12.09-.243.118-.368l-.52-1.171c-.224-.5-.023-1.09.528-1.32l2.247-1.296c.399-.23.916-.025 1.14.475l.486 1.09c.12-.052.243-.09.368-.118l.217-1.313zM12 15.75a3.75 3.75 0 100-7.5 3.75 3.75 0 000 7.5z" />
    </svg>
);
...
export const ExternalLinkIcon: React.FC<IconProps> = ({ className = 'h-5 w-5 inline-block mr-1' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
